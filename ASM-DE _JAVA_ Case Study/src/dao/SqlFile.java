...
public class SqlFile {
	...
	public static final String query1 = "select *" + "from cdw_sapp_creditcard cr "
			...
			+ "WHERE (cb.CUST_ZIP = ? AND cr.MONTH = ?  AND cr.YEAR = ?) " + "order by DAY desc";// REMOVED HARD CODED ZIPCODE-CV
	...
	public static final String query3 = "SELECT count(*) '# of Transaction', sum(TRANSACTION_VALUE)"
			...
			+ "GROUP BY branch.BRANCH_NAME"; // CHANGED CARD.BRANCH_NAME TO BRANCH.BRANCH_NAME -CV
